...
public final class BuyOrNotMapper: Sendable {
    ...
    public func toEntity(dto: BuyOrNotDTO) -> BuyOrNotCardViewEntity {
...
extension BuyOrNotMapper: DependencyKey {
    public static let liveValue: BuyOrNotMapper = BuyOrNotMapper()
}

extension DependencyValues {
    public var buyOrNotMapper: BuyOrNotMapper {
