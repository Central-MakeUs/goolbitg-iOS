...
public final class JWTManager: Sendable {
    
    public func makeAppleClientSecretJWT() -> String {
...
extension JWTManager: DependencyKey {
    public static let liveValue: JWTManager = JWTManager()
}
extension DependencyValues {
    public var jwtManager: JWTManager {
        get {
