...
public final class PushNotiManager: NSObject, @unchecked Sendable {
    ...
    public let publishNewMessageCount = PassthroughSubject<Int, Never>()
...
extension PushNotiManager {
    ...
    public func getNotificationCurrentSetting() async -> PushAuthCase {
...
extension PushNotiManager: DependencyKey {
    public static let liveValue: PushNotiManager = PushNotiManager()
}

extension DependencyValues {
    public var pushNotiManager: PushNotiManager {
