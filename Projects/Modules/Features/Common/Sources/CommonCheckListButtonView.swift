...
extension CommonCheckListConfiguration {
    public var currentStateTextColor: Color {
        return currentState ? GBColor.main.asColor : GBColor.white.asColor
    }
    
    public var currentStateSubTextColor: Color {
...
public struct CommonCheckListButtonView: View {
    
    public let configuration: CommonCheckListConfiguration
    
    public init(configuration: CommonCheckListConfiguration) {
