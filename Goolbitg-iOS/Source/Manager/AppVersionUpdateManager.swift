...
final class AppVersionUpdateManager {
    ...
    func checkBuildVersionUpdate() async -> Bool? {
...
extension AppVersionUpdateManager: DependencyKey {
    static let liveValue: AppVersionUpdateManager = AppVersionUpdateManager()
}

extension DependencyValues {
    var appVersionUpdateManager: AppVersionUpdateManager {
